...
Planning rule:
- Any planned work with phases must create all phase subtasks up front.
- As work progresses, update each phase subtask status in Monday during execution (not only at the end).
