...
create table public.product (
  ...
  kind text not null default 'manufactured',
  created_at timestamptz not null default now(),
...
create index product_variant_tenant_barcode_idx
...
create table public.order_line_consumption (
  id uuid primary key default gen_random_uuid(),
  tenant_id uuid not null references public.tenant(id),
...
create index order_line_consumption_tenant_order_idx
